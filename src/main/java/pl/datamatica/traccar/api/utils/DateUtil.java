...
public class DateUtil {
    private static final SimpleDateFormat rfc1123 = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz");
    private static final SimpleDateFormat rfc850 = new SimpleDateFormat("EEEE,  dd-MMM-yy HH:mm:ss zzz");
    private static final SimpleDateFormat asctime = new SimpleDateFormat("EEE MMM  d HH:mm:ss yyyy");
