...
public class DeviceGroupProviderTest  {
    ...
    public void getAll_admin() throws ProviderException {
        ...
        provider.setDeviceProvider(new DeviceProvider(em, database.admin, new ImeiProvider(em), provider));
    ...
    public void getAll_managedUser() throws ProviderException {
        ...
        provider.setDeviceProvider(new DeviceProvider(em, database.managedUser, new ImeiProvider(em), provider));
    ...
    public void getAll_managed2User() throws ProviderException {
        ...
        provider.setDeviceProvider(new DeviceProvider(em, database.managed2, new ImeiProvider(em), provider));
    ...
    public void getAll_managed3User() throws ProviderException {
        ...
        provider.setDeviceProvider(new DeviceProvider(em, database.managed3, new ImeiProvider(em), provider));
